...
libgrand_utillib.a: Makefile aires_util.c hardware_util.c antenna_util.c complex_util.c fft_util.c matrix.c io_util.c reco_util.c
	g++ -c -I$(EVENTDIR) -I$(ANTENNADIR) -I${ROOTSYS}/include aires_util.c antenna_util.c hardware_util.c complex_util.c fft_util.c matrix.c reco_util.c io_util.c -std=c++11
